...
int main(void)
{
    ...
    unsigned long long a[LENTH] = {0}, b[LENTH] = {0}, c[LENTH] = {0}, mersenne[LENTH] = {0};

    char output[10 * LENTH + 1] = {0}; //最后一位封尾

    start_t = clock();
    int is_prime[2010] = {0}; // 1代表是质数
...
void generate_mersenne(unsigned long long *mersenne, int p) //生成梅森数
{
    clear(mersenne);
    int pos;
